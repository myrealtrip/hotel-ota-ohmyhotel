...
class CancelConsumeServiceTest {
    ...
    @BeforeEach
     void beforeEach() {
        devCancelConsumeService = new CancelConsumeService(omhCancelBookingAgent, reservationProvider, reservationApiLogService, bookingOrderMessageConverter, reservationSlackSender, "dev");
        prodCancelConsumeService = new CancelConsumeService(omhCancelBookingAgent, reservationProvider, reservationApiLogService, bookingOrderMessageConverter, reservationSlackSender, "prod");
    }
