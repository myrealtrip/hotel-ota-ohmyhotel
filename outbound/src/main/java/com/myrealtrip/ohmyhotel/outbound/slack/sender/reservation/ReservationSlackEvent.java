...
public enum ReservationSlackEvent {
    ...
    RESERVE_CONFIRM_RESPONSE_CHECK_FAIL("[오마이호텔] 예약확정 응답 수신 실패", "오마이호텔 예약확정 응답을 수신하지 못했습니다. 원인 확인이 필요합니다. 최종 처리 결과를 알 수 없어 Pending 상태로 변경합니다. Pending 상태의 예약은 배치를 통해 재시도 됩니다."),
