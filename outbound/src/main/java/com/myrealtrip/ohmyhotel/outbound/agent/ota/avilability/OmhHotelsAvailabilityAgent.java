...
public class OmhHotelsAvailabilityAgent {
    ...
    public OmhHotelsAvailabilityResponse getHotelsAvailability(OmhHotelsAvailabilityRequest request) {
        try {
            ...
            log.error(AgentConstants.LOG_FORMAT, HOTELS_AVAILABILITY, ObjectMapperUtils.writeAsString(request), ObjectMapperUtils.writeAsString(e.getOmhCommonResponse()));
            throw e;
        } catch (Throwable e) {
